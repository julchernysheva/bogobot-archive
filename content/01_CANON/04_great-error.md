...
Позже этот каскад событий Техножрецы назовут [[04_great-error|Великой Ошибкой]].
...
Техножрецы спорят о происхождении [[04_great-error|Великой Ошибки]].
...
Поэтому происхождение [[04_great-error|Великой Ошибки]] остаётся открытым.
...
[[04_great-error|Великая Ошибка]] и коллапс модели описывают два полюса одного процесса.
